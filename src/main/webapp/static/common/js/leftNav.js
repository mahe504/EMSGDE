		...
		if(data[i].children != undefined && data[i].children.length > 0){
			...
			for(var j=0;j<data[i].children.length;j++){
				if(data[i].children[j].target == "_blank"){
					ulHtml += '<dd class="'+data[i].classs+'"><a href="javascript:;" data-url="'+data[i].children[j].href+'" target="'+data[i].children[j].target+'">';
				}else{
					ulHtml += '<dd class="'+data[i].classs+'"><a href="javascript:;" data-url="'+data[i].children[j].href+'">';
				}
